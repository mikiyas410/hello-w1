...
import 'package:adrash/utils/helpers/snackbar_helper.dart';
import 'package:adrash/values/app_regex.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future register() async{
    ...
    var url = Uri.parse("http://localhost/Adrash/adrash/Database/v1/userLogin.php");
